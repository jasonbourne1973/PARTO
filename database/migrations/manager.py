...
class MigrationManager:
    ...
    def _run_step(connection, module, version, direction, new_version):
        ...
        بزند، آنچه تا آن نقطه commit شده قابل بازگشت نیست؛ ولی شمارهٔ نسخه
        باز هم فقط پس از موفقیت کامل گام نوشته می‌شود، پس دیتابیس هرگز
        «نسخهٔ جدید» با اسکیمای ناقص مُهر نمی‌خورد.
        """
