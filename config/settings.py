...
# پوشهٔ پشتیبان‌ها (بازرسی شانزدهم): قبلاً صفحهٔ پشتیبان‌گیری و تنظیمات هر
# کدام جداگانه «views/backups» را می‌ساختند؛ یعنی فایل‌های دادهٔ کاربر داخل
# درخت کد. حالا یک مسیر واحد کنار دیتابیس/پیوست‌ها. پشتیبان‌های پوشهٔ
# قدیمی هنگام بازکردن صفحهٔ پشتیبان‌گیری به این‌جا منتقل می‌شوند.
BACKUP_DIR = os.path.join(BASE_DIR, "backups")
LEGACY_BACKUP_DIR = os.path.join(BASE_DIR, "views", "backups")
